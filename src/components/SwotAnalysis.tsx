...
export const SwotAnalysis = () => {
  return (
    <div className="grid grid-cols-2 grid-rows-2 border-(--gray) border-3 mx-auto aspect-square w-[80%] shadow-lg rounded-lg">
      <Card title={t("swot.sterktes.title")} className={"border-(--gray) border-2 w-full h-full"}>
      ...
      <Card title={t("swot.zwaktes.title")} className={"border-(--gray) border-2 w-full h-full"}>
        <span className="flex flex-col gap-4">
      ...
      <Card title={t("swot.bedreigingen.title")} className={"border-(--gray) border-2 w-full h-full"}>
        <span className="flex flex-col gap-4">
